...
public class Task {
    ...
    @Description("Проверка, что заголовки корректно отображаются.")
    ...
    @Description("Проверка, что платежные логотипы все отображаются.")
    ...
    @Description("Проверка ссылки на вкладку \"Подробнее\"")
